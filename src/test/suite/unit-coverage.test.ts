...
`;
    ...
    test('Test URI operations', () => {
        ...
        // Test HTTP URI
        const httpUri = vscode.Uri.parse('https://www.promptingguide.ai/techniques');
        assert.ok(httpUri);
        assert.strictEqual(httpUri.scheme, 'https');
        assert.strictEqual(httpUri.authority, 'www.promptingguide.ai');
        assert.strictEqual(httpUri.path, '/techniques');
    });
